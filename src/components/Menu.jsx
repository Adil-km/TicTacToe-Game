...
<div className="bg-orange-200 h-svh p-4 pt-10 flex flex-col items-center justify-center gap-8 bg-gradient-to-b ">
      ...
      <div className="text-center mb-8 cursor-default">
        <h2 className="sm:text-7xl text-5xl font-extrabold text-rose-800 mb-3 animate-pulse tracking-wide transition-all duration-300">
          Welcome to
        </h2>
    ...
    <Link to="/play/player" tabIndex={-1}>
      <Button><img className='w-15 sm:max-w-15 max-w-10 inline pr-4 mb-2' src={pvpIcon}/>Two Player</Button>
    </Link>

    <Link to="/play/computer" tabIndex={-1}>
      <Button ><img className='w-15 sm:max-w-15 max-w-10 inline pr-4 mb-2' src={computerIcon}/>Computer vs Player</Button>
    </Link>
