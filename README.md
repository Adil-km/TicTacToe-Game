...
* **🔁 Game Restart:** Easily reset the board to start a new match anytime.
...
2. **Take Turns:** Players (or AI) alternate to place “X” and “O” on the grid.
3. **Win or Draw:** The app detects the winner or a draw automatically.
